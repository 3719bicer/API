...
public class C17_BaseUrlHerokuappQueryParam extends HerokuAppBaseUrl {
    ...
    */
    ...
    /*
        1-  https://restful-booker.herokuapp.com/booking endpointine bir GET
        request gonderdigimizde donen response’un status code’unun 200 oldugunu
        ve Response’ta 2734 id'ye sahip bir booking oldugunu test edin
     */
        // 1 - URL hazirla
        ...
        response.
                ...
                assertThat().
                statusCode(200).
                body("bookingid", Matchers.hasItem(2734));
    }
    ...
    */
        ...
        response.
                ...
                assertThat().
                statusCode(200).
                body("bookingid",Matchers.hasSize(3));//Matchers.greaterThan(1))
    }
